...
/**
 * Most of the program's functionality is in this FlightFeed class
 */
public class FlightFeed extends Subject{
	...
	/**
	 * When you call the “start” method on a FlightFeed object,
	 * it downloads information about all currently in-air flights,
	 * and selects one of them to monitor.
	 * The selected flight’s status is stored in the FlightFeed object’s “flight” property.
	 * After initializing its “flight” property, every 60 seconds the
	 * FlightFeed object downloads the current status of the flight being monitored,
	 * and if the flight’s status has changed, it updates the value of its “flight” property
	...
	public void start() {
		...
		if (allFlights != null && allFlights.states.size() > 0) {
			...
			// System.out.println(_flight.toString());	// Step 6. "Remove the calls to System.out.println in Flight Feed..."
